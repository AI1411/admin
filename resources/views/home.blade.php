                        ...
                        <div class="card">
                            <div class="card-header" style="display: flex">
                                ...
                                <div class="input-group ml-3" style="width: 30%">
                                    <input type="text" class="form-control rounded-0" name="searchTodo">
                                    <span>
                                        <button class="btn btn-info">Search!</button>
                                    </span>
                                </div>

                                <div class="card-tools mt-auto mb-auto ml-auto">
                                ...
                                <ul class="todo-list" data-widget="todo-list">
                                    @foreach($todos as $key => $todo)
                                        <li>
                                            ...
                                            <!-- todo text -->
                                            <span
                                                class="text">{{ mb_strimwidth($todo->title, 0, 50, '...', 'utf8') }}</span>
                                            <!-- Emphasis label -->
                                            <small class="badge badge-{{ $todo->statusBadge }}"><i
                                                    class="far fa-clock"></i>
                                                {{ $todo->status->name }}</small>
                                            ...
                                            <div class="tools">
                                                ...
                                                <a href="{{ route('todos.destroy', $todo->id) }}"
                                                   onclick="event.preventDefault();document.getElementById('delete-todo').submit()">
                                                    <i class="fas fa-trash"></i>
                                                </a>
                                                <form id="delete-todo" action="{{ route('todos.destroy', $todo->id) }}"
                                                      method="post" style="display: none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                {{--                                                <a href="" class="swalDefaultInfo" onclick="submit(this.form)">--}}
                                                {{--                                                    @csrf--}}
                                                {{--                                                    @method('DELETE')--}}
                                                {{--                                                    <i class="fas fa-trash"></i>--}}
                                                {{--                                                </a>--}}
